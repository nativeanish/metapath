...
export default function BentoLight(props: SocialLinkProps) {
  return (
    <div className={`font-sans mainBody bg-[#e3dff2]`}>
      <div className="text-black relative mx-auto h-full w-[700px] max-w-full p-8 md:p-16 xl:w-[1400px]">
        <div className="mb-12 w-full xl:fixed xl:mb-0 xl:w-[500px]">
          {props.image ? (
            <img
              className="border-black h-28 w-28 rounded-full border-2 xl:h-[184px] xl:w-[184px] bg-white"
              src={props.image}
        ...
        <div className="justify-end xl:flex">
          <div
            id="grid-container"
            className="text-text grid w-full grid-cols-2 gap-10 md:grid-cols-3 xl:w-1/2 xl:pb-16 w450:grid-cols-1 w450:gap-7"
          >
